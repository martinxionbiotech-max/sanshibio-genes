...
很多鸽友第一次接触[赛鸽飞行能力基因检测](https://sanshibio.com/flight-ability/)时，最大的困惑不是「测什么」，而是「为什么测几个碱基位点就能判断耐力、归巢这些复杂性状」。要真正读懂检测报告，就需要先掌握一点**赛鸽遗传学基础**。
...
[飞行能力基因检测](https://sanshibio.com/flight-ability/)通过检测 LDHA、MSTN 等功能基因的关键 SNP 位点，判断赛鸽的遗传潜力；[基因身份证](gene-id-card.md)则利用 58 个 SNP 位点组合识别个体身份。二者本质都是「读碱基、判基因型」。

## 实操步骤：从遗传学基础到选育落地

1. **建立认知**：理解「基因型 = 潜力、表型 = 表现」，避免把检测结果当绝对结论
2. **明确目标**：先确定要打短程速度赛还是长程耐力赛，再决定关注哪些基因
3. **检测建档案**：为核心种鸽做[飞行能力基因检测](https://sanshibio.com/flight-ability/)，记录基因型
